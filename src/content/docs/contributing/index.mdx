...
description: "Repository layout, local development, tests, and release workflow for contributors."
---
...
- See [Development Setup](/contributing/development) to learn how to set up your local development environment
- See [Testing Guide](/contributing/testing) to understand the test framework and workflow
- See [Release Process](/contributing/release) to learn about version release rules
