...
Use mirroring to validate a new backend version against real traffic, warm caches in a staging environment, or replay production traffic for offline analysis. See the [Request Mirroring](/configuration/request-mirroring/) guide for detailed configuration.
...
See [Token Policy](/features/ai-gateway/#token-policy) in the AI Gateway docs and [Rate Limiting Configuration](/configuration/rate-limiting/) for operational details.
...
- [Request Mirroring](/configuration/request-mirroring/)
