...
The chart defaults to `latest` image tags with `pullPolicy: IfNotPresent`. In production, override this with a specific release tag or an image digest in your values file.
