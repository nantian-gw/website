...
description: "Deploy Nantian Gateway in high availability mode: multi-replica control plane with leader election, data plane scaling, anti-affinity, and PDBs."
---
