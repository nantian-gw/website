---
title: Upgrade Guide
description: "Upgrade Nantian Gateway between versions: pre-upgrade checks, Helm upgrade workflow, CRD migration, configuration compatibility, and rollback procedures."
---
