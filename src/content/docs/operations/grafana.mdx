...
description: "Set up Grafana dashboards for Nantian Gateway: pre-built JSON dashboards for control plane, data plane, and AI gateway metrics visualization."
---
...
:::note
Grafana alerts are evaluated by the Grafana server, not Prometheus. For production alerting, configure Prometheus alerting rules and use Alertmanager for notification routing. See [Alerting Rules](/operations/alerting) for recommended rules.
:::
...
- [Alerting Rules](/operations/alerting) -- configure alerts for the metrics you're now monitoring
- [Metrics Reference](/operations/metrics) -- complete catalog of all metrics used in the dashboard
- [Troubleshooting](/operations/troubleshooting) -- what to do when the dashboard shows problems
