...
description: "Complete Prometheus metrics reference for Nantian Gateway: control plane snapshot, admin API, xDS, and data plane metrics with labels and descriptions."
---
...
- [Grafana Dashboard](/operations/grafana) -- import and customize the pre-built dashboard
- [Alerting Rules](/operations/alerting) -- alerting rules you should configure
- [Configuration: Observability](/configuration/observability) -- logging, metrics, and tracing configuration
