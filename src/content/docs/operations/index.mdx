...
description: "Day-two operations for logs, metrics, health checks, troubleshooting, alerting, and backup workflows."
---
...
| Page | Covers |
| --- | --- |
| [Metrics Reference](/operations/metrics/) | Prometheus metrics emitted by the control plane and data plane. |
| [Grafana Dashboard](/operations/grafana/) | How to import and use the bundled dashboard assets. |
| [Alerting Rules](/operations/alerting/) | Recommended Prometheus alert rules. |
| [Troubleshooting](/operations/troubleshooting/) | Common symptoms and diagnostic flows. |
| [Backup & Recovery](/operations/backup/) | What to back up and how to restore gateway configuration. |
