---
title: Use Cases
description: "Common deployment scenarios for Nantian Gateway: API gateway for microservices, AI provider routing, Kubernetes ingress replacement, and multi-cluster traffic management."
---
