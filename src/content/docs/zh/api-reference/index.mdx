...
Nantian Gateway 扩展了标准 Gateway API，引入了四个自定义资源定义，归属 `gateway.nantian.io/v1alpha1` API 组：
...
四个 CRD 可以在路由级别或后端级别引用，灵活控制 AI 服务连接、Token 限制、Wasm 插件注入和负载均衡行为。完整字段规范见 [自定义 CRD](/zh/api-reference/crds) 参考文档。
