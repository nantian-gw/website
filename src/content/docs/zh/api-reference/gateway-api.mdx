...
Nantian Gateway 实现了 [Kubernetes Gateway API v1.5.1](https://gateway-api.sigs.k8s.io/) 规范，声明支持 68 个特性。本页列出所有支持的资源类型、核心字段和特性覆盖情况。
...
Nantian Gateway 声明支持 Gateway API v1.5.1 规范中的 68 个特性。以下按类别列出关键特性：
