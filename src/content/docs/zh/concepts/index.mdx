---
title: 核心概念
description: "Nantian Gateway分离式路由模型和 Gateway API 资源关系的核心概念。"
---

本章节介绍 Nantian Gateway 和 Kubernetes Gateway API 的基本概念。如果您是 API 网关、Kubernetes Ingress 或 Gateway API 规范的新用户，请从这里开始。

这些页面解释的是「是什么」和「为什么」，而非「怎么做」。具体实现细节请参阅[快速开始](/zh/getting-started/quick-start)和[配置](/zh/configuration/)章节。
...
- [理解 Gateway API](/zh/concepts/gateway-api) — 学习资源模型
- [分离式平面架构](/zh/concepts/split-plane) — 理解控制面和数据面设计
- [快速开始](/zh/getting-started/quick-start) — 五分钟部署 Nantian Gateway
