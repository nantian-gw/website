---
title: 控制面设计
slug: zh/1.5/architecture/controlplane
---
...
* [数据面设计](/zh/1.5/architecture/dataplane) — Rust 代理如何处理流量
* [Admin API](/zh/1.5/architecture/admin-api) — Admin 服务器 API 参考
* [配置：控制面](/zh/1.5/configuration/controlplane) — 所有配置参数
