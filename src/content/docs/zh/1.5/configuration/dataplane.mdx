---
title: 数据面配置
slug: zh/1.5/configuration/dataplane
---
...
当控制面开启了 [gRPC TLS](/zh/1.5/configuration/tls#grpc-tls) 之后，把地址改成 `https://` 开头。
...
| `runtimeTuning.httpCapacity.reusePort` | bool/null | null | 开启 SO\_REUSEPORT（null = 系统默认） |
