...
description: "如何组织Nantian Gateway 1.5 Helm values 文件、哪些配置组最重要，以及变更上线前如何校验。"
slug: zh/1.5/configuration/helm-values
---
...
这篇指南重点讲 values 文件怎么组织、哪些配置组最值得优先关注。完整安装流程请看 [Helm 安装](/zh/1.5/installation/helm/)，生产硬化建议请继续阅读 [生产环境部署](/zh/1.5/installation/production/)。
...
如果你改的是 chart 版本，请结合 [升级指南](/zh/1.5/installation/upgrade/) 一起看；如果改动涉及 TLS、资源规模或高可用参数，请同时对照 [生产环境部署](/zh/1.5/installation/production/) 进行复核。
