...
| 渠道 | 用途 |
|------|------|
| [GitHub Issues](https://github.com/nantian-gw/gateway/issues) | Bug 报告、功能请求 |
| [GitHub Discussions](https://github.com/nantian-gw/gateway/discussions) | 技术讨论、使用问题、设计提案 |
| [Slack](https://nantian-gw.slack.com) | 实时交流、社区支持 |
