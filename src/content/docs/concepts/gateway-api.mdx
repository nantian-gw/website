...
For a complete list of supported features, see the [Gateway API Support](/concepts/gateway-api-support) matrix.

## HTTPRoute Filters and Traffic Shaping
...
| **BackendLBPolicy** | Service | Session persistence configuration |
| **Nantian RoutePolicy** | HTTPRoute, GRPCRoute | Timeout, retry, and circuit breaker overrides |
| **Nantian TokenPolicy** | HTTPRoute | Per-route token usage limits |
