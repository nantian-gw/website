...
For production deployments, reference the included `production-values.yaml` as a starting point. This file enables TLS, configures resource limits appropriate for production workloads, and sets the data plane to connect to the control plane over HTTPS.
