...
- [Gateway API Concepts](/en/concepts/gateway-api) — understand the Kubernetes resources the control plane watches
- [Architecture Details](/en/architecture/) — deep dive into control plane and data plane internals
- [Quick Start](/en/getting-started/quick-start) — deploy the split-plane architecture in your cluster