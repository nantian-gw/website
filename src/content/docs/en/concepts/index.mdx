...
These pages explain the *what* and *why* before the *how*. For implementation details, see the [Getting Started](/en/getting-started/quick-start) and [Configuration](/en/configuration/) sections.
...
- [Understanding the Gateway API](/en/concepts/gateway-api) — learn the resource model
- [Split-Plane Architecture](/en/concepts/split-plane) — understand the control plane and data plane design
- [Quick Start](/en/getting-started/quick-start) — deploy Nantian Gateway in five minutes