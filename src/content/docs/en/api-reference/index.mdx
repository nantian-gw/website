...
All four CRDs can be referenced at the route level or backend level, giving you flexible control over AI service connections, token limits, Wasm plugin injection, and load balancing behavior. See the [Custom CRDs](/en/api-reference/crds) reference for full field specifications.
