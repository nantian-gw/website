...
For a complete metric reference, see [Metrics Reference](/en/operations/metrics).
...
- [Metrics Reference](/en/operations/metrics) — complete reference of all available metrics
- [Grafana Dashboard](/en/operations/grafana) — pre-built dashboards for visualization
- [Alerting Rules](/en/operations/alerting) — recommended alerting configurations