...
- [Observability](/en/configuration/observability) — configure metrics, logs, and traces for monitoring
- [Metrics Reference](/en/operations/metrics) — detailed metric descriptions
- [Production Deployment](/en/installation/production/) — production resource sizing guidance