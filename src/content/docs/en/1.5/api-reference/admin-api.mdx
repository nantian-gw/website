---
title: Admin API
slug: en/1.5/api-reference/admin-api
---
...
* See [xDS Protocol](/en/1.5/api-reference/xds-proto) for communication protocol details between the control plane and data plane
* See [Troubleshooting](/en/1.5/operations/troubleshooting) for diagnostic methods for common issues
* See [Metrics Reference](/en/1.5/operations/metrics) for Prometheus metric definitions
