...
slug: en/1.5/api-reference/gateway-api
---
...
* See [Custom CRDs](/en/1.5/api-reference/crds) for Nantian Gateway's extension resources
* See [Quick Start](/en/1.5/getting-started/quick-start) to deploy your first gateway
* See [First Route](/en/1.5/getting-started/first-route) to create your first routing rule
