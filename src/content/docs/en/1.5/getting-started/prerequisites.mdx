---
title: Prerequisites
slug: en/1.5/getting-started/prerequisites
---
...
After verifying all prerequisites, proceed to the [Quick Start](/en/1.5/getting-started/quick-start) to deploy Nantian Gateway.
