...
slug: en/1.5/getting-started/first-route
---
...
* **Installation options**: Learn about [Helm customization](/en/1.5/installation/helm), [Kustomize overlays](/en/1.5/installation/kustomize), and [production deployment](/en/1.5/installation/production).
* **TLS configuration**: Set up [TLS listeners and mTLS](/en/1.5/configuration/tls) for secure traffic.
* **Observability**: Enable [metrics scraping](/en/1.5/operations/metrics) and set up [Grafana dashboards](/en/1.5/operations/grafana).
* **Architecture**: Read the [architecture overview](/en/1.5/architecture/) to understand the control plane and data plane split.
* **API reference**: Browse the [Gateway API resources](/en/1.5/api-reference/gateway-api) and [custom CRDs](/en/1.5/api-reference/crds).
