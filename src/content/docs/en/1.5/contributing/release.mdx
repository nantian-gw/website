...
slug: en/1.5/contributing/release
---
...
* See [Testing Guide](/en/1.5/contributing/testing) to understand the CI pipeline
* See [Development Setup](/en/1.5/contributing/development) to learn about local builds
