...
slug: en/1.5/operations/metrics
---
...
* [Grafana Dashboard](/en/1.5/operations/grafana) -- import and customize the pre-built dashboard
* [Alerting Rules](/en/1.5/operations/alerting) -- alerting rules you should configure
* [Configuration: Observability](/en/1.5/configuration/observability) -- logging, metrics, and tracing configuration
