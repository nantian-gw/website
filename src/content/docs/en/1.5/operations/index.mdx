...
| Page | Covers |
| --- | --- |
| [Metrics Reference](/en/1.5/operations/metrics/) | Prometheus metrics emitted by the control plane and data plane. |
| [Grafana Dashboard](/en/1.5/operations/grafana/) | How to import and use the bundled dashboard assets. |
| [Alerting Rules](/en/1.5/operations/alerting/) | Recommended Prometheus alert rules. |
| [Troubleshooting](/en/1.5/operations/troubleshooting/) | Common symptoms and diagnostic flows. |
| [Backup & Recovery](/en/1.5/operations/backup/) | What to back up and how to restore gateway configuration. |
