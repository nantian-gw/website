...
slug: en/1.5/concepts/split-plane
---
...
* [Gateway API Concepts](/en/1.5/concepts/gateway-api) — understand the Kubernetes resources the control plane watches
* [Architecture Details](/en/1.5/architecture/) — deep dive into control plane and data plane internals
* [Quick Start](/en/1.5/getting-started/quick-start) — deploy the split-plane architecture in your cluster
