---
title: Observability
slug: en/1.5/configuration/observability
---
...
For a complete metric reference, see [Metrics Reference](/en/1.5/operations/metrics).
...
* [Metrics Reference](/en/1.5/operations/metrics) — complete reference of all available metrics
* [Grafana Dashboard](/en/1.5/operations/grafana) — pre-built dashboards for visualization
* [Alerting Rules](/en/1.5/operations/alerting) — recommended alerting configurations
