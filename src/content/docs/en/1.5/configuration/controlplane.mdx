...
slug: en/1.5/configuration/controlplane
---
...
The admin API provides full read and write access to gateway resources. Never expose `adminAddr` to external networks without TLS and authentication. See the [TLS configuration](/en/1.5/configuration/tls) page for securing it.
:::
...
Refer to the [TLS / mTLS](/en/1.5/configuration/tls) page for detailed TLS configuration.
...
* [Data Plane Configuration](/en/1.5/configuration/dataplane) — data plane config reference
* [TLS / mTLS](/en/1.5/configuration/tls) — detailed TLS configuration guide
* [Observability](/en/1.5/configuration/observability) — logging, metrics, and tracing configuration
