...
* [Control Plane Design](/en/1.5/architecture/controlplane) -- deep dive into the translator, reconciler, and xDS server
* [Data Plane Design](/en/1.5/architecture/dataplane) -- how the Rust proxy routes traffic and applies configuration
* [Admin API](/en/1.5/architecture/admin-api) -- API reference for the built-in admin and dashboard server
