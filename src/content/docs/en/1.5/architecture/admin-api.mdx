---
title: Admin API
slug: en/1.5/architecture/admin-api
---
...
:::caution
The Admin API provides full read access to your gateway configuration, including secrets, backend addresses, and route details. Never expose `adminAddr` to external networks without TLS and authentication. See [TLS / mTLS](/en/1.5/configuration/tls) for configuration details.
:::
...
* [API Reference: Admin API](/en/1.5/api-reference/admin-api) -- OpenAPI specification and client libraries
* [Operations: Metrics Reference](/en/1.5/operations/metrics) -- complete Prometheus metrics catalog
* [Configuration: Control Plane](/en/1.5/configuration/controlplane) -- admin server configuration
