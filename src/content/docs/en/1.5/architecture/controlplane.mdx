...
slug: en/1.5/architecture/controlplane
---
...
* [Data Plane Design](/en/1.5/architecture/dataplane) -- how the Rust proxy handles traffic
* [Admin API](/en/1.5/architecture/admin-api) -- API reference for the admin server
* [Configuration: Control Plane](/en/1.5/configuration/controlplane) -- all configuration parameters
