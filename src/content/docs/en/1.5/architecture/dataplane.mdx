...
slug: en/1.5/architecture/dataplane
---
...
* [Admin API](/en/1.5/architecture/admin-api) -- API for inspecting and managing the gateway
* [Metrics Reference](/en/1.5/operations/metrics) -- complete Prometheus metrics catalog
* [Configuration: Data Plane](/en/1.5/configuration/dataplane) -- all configuration parameters
