...
slug: en/1.5/installation/production
---
...
**Downstream TLS** for traffic entering the gateway. This is configured through Gateway API listeners, not the Helm chart. See the [TLS configuration guide](/en/1.5/configuration/tls) for details.
