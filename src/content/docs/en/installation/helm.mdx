...
The chart includes a `production-values.yaml` that hardens the deployment for production use. It enables TLS, sets resource limits appropriate for production workloads, and locks down security contexts:
...
Review the file before deploying. You'll need to update the image registry, tag, and pull secrets to match your environment.
