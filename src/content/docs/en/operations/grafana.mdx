...
:::note
Grafana alerts are evaluated by the Grafana server, not Prometheus. For production alerting, configure Prometheus alerting rules and use Alertmanager for notification routing. See [Alerting Rules](/en/operations/alerting) for recommended rules.
:::
...
- [Alerting Rules](/en/operations/alerting) -- configure alerts for the metrics you're now monitoring
- [Metrics Reference](/en/operations/metrics) -- complete catalog of all metrics used in the dashboard
- [Troubleshooting](/en/operations/troubleshooting) -- what to do when the dashboard shows problems
