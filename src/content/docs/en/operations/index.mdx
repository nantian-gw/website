...
| Page | Covers |
| --- | --- |
| [Metrics Reference](/en/operations/metrics/) | Prometheus metrics emitted by the control plane and data plane. |
| [Grafana Dashboard](/en/operations/grafana/) | How to import and use the bundled dashboard assets. |
| [Alerting Rules](/en/operations/alerting/) | Recommended Prometheus alert rules. |
| [Troubleshooting](/en/operations/troubleshooting/) | Common symptoms and diagnostic flows. |
| [Backup & Recovery](/en/operations/backup/) | What to back up and how to restore gateway configuration. |
