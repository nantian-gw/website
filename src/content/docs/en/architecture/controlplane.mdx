...
- [Data Plane Design](/en/architecture/dataplane) -- how the Rust proxy handles traffic
- [Admin API](/en/architecture/admin-api) -- API reference for the admin server
- [Configuration: Control Plane](/en/configuration/controlplane) -- all configuration parameters