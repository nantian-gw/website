...
- [Admin API](/en/architecture/admin-api) -- API for inspecting and managing the gateway
- [Metrics Reference](/en/operations/metrics) -- complete Prometheus metrics catalog
- [Configuration: Data Plane](/en/configuration/dataplane) -- all configuration parameters