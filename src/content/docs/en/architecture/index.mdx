...
- [Control Plane Design](/en/architecture/controlplane) -- deep dive into the translator, reconciler, and xDS server
- [Data Plane Design](/en/architecture/dataplane) -- how the Rust proxy routes traffic and applies configuration
- [Admin API](/en/architecture/admin-api) -- API reference for the built-in admin and dashboard server