---
title: Quick Start
description: "Deploy Nantian Gateway with Helm in 5 minutes. Covers adding the chart repo, installing with defaults, and verifying your first gateway deployment."
---
  ...
  template:
    ...
    spec:
      containers:
        ...
        # If the echo-server image is unavailable, use busybox as a fallback:
        # image: busybox:1.36.1
        # command: ["sh", "-c", "while true; do echo -e 'HTTP/1.1 200 OK\r\n\r\nhello' | nc -l -p 80 -q 1; done"]
          ports:
            - containerPort: 80
          env:
            - name: PORT
