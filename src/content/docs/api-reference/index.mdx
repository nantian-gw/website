...
Nantian Gateway is based on [Gateway API v1.5.1](https://gateway-api.sigs.k8s.io/) and declares support for **55 features** across the Core, Extended, and Implementation-specific conformance levels. The specific feature gate coverage is detailed in the [Gateway API Resources](/api-reference/gateway-api) reference.
