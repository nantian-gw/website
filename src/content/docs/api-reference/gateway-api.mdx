...
description: "Reference for standard Gateway API resources supported by Nantian: GatewayClass, Gateway, HTTPRoute, GRPCRoute, TCPRoute, UDPRoute, TLSRoute, and policies."
---

Nantian Gateway implements the [Kubernetes Gateway API v1.5.1](https://gateway-api.sigs.k8s.io/) specification and declares support for 54 features. This page lists all supported resource types, core fields, and feature coverage.
...
Nantian Gateway declares support for 54 features in the Gateway API v1.5.1 specification. Key features are listed below by category:
...
| Feature | Status |
|---------|--------|
| HTTPRouteQueryParamMatching | Supported |
| HTTPRouteMethodMatching | Supported |
...
| MeshHTTPRouteBackendRequestHeaderModification | Supported |
| MeshHTTPRouteNamedRouteRule | Supported |
| MeshHTTPRouteQueryParamMatching | Supported |
| MeshHTTPRouteRedirectPath | Supported |
| MeshHTTPRouteRedirectPort | Supported |
| MeshHTTPRouteRewritePath | Supported |
| MeshHTTPRouteSchemeRedirect | Supported |
...
- See [Custom CRDs](/api-reference/crds) for Nantian Gateway's extension resources
- See [Quick Start](/getting-started/quick-start) to deploy your first gateway
- See [First Route](/getting-started/first-route) to create your first routing rule
