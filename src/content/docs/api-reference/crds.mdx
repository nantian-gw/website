...
description: "Reference for Nantian Gateway custom resource definitions: AIService, TokenPolicy, WasmPlugin, and BackendLBPolicy — schemas, fields, and examples."
---
