---
title: Quick Start
description: "Step-by-step guide to install Nantian Gateway with Helm, create a demo backend, and route your first request in under five minutes."
slug: 1.5/getting-started/quick-start
---
