...
description: "Complete reference for Nantian Gateway's Gateway API implementation covering all supported resources and 54 conformance features."
slug: 1.5/api-reference/gateway-api
---
...
* See [Custom CRDs](/1.5/api-reference/crds) for Nantian Gateway's extension resources
* See [Quick Start](/1.5/getting-started/quick-start) to deploy your first gateway
* See [First Route](/1.5/getting-started/first-route) to create your first routing rule
