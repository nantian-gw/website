...
description: "Complete reference for Nantian Gateway's Gateway API implementation covering all supported resources and 68 conformance features."
slug: 1.5/api-reference/gateway-api
---

Nantian Gateway implements the [Kubernetes Gateway API v1.5.1](https://gateway-api.sigs.k8s.io/) specification and declares support for 68 features. This page lists all supported resource types, core fields, and feature coverage.
...
Nantian Gateway declares support for 68 features in the Gateway API v1.5.1 specification. Key features are listed below by category:
