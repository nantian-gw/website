...
The control plane Admin API is exposed on the control plane pod's HTTP port (default `18081`) and provides a cluster-level configuration view as well as xDS client management.
...
curl http://<controlplane-pod>:18081/healthz
...
curl http://<controlplane-pod>:18081/api/v1/config/snapshot/version
# Example response:
# {
...
curl http://<controlplane-pod>:18081/api/v1/config/snapshot
...
curl http://<controlplane-pod>:18081/api/v1/clients
...
curl http://<controlplane-pod>:18081/api/v1/clients/dataplane-7f8a9b-0
```
...
curl http://<controlplane>:18081/api/v1/config/snapshot/version
...
curl http://<controlplane>:18081/api/v1/clients
```
...
curl http://<controlplane>:18081/api/v1/backends/default/backend-v1
...
curl http://<controlplane>:18081/api/v1/clients | jq '.[] | {node_id, connected_since, last_config_status}'
