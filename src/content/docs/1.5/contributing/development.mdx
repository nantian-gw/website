...
description: "Set up a local development environment for Nantian Gateway covering Go control plane, Rust data plane, Protobuf compilation, and debugging workflows."
slug: 1.5/contributing/development
---
...
See the [Control Plane Configuration](/1.5/configuration/controlplane) reference for the full schema, including leader election and the GatewayClass name.
...
See the [Data Plane Configuration](/1.5/configuration/dataplane) reference for the full schema.
...
* See [Testing Guide](/1.5/contributing/testing) to learn how to run tests
* See [Architecture Overview](/1.5/architecture/) to understand the system design
* See [Contributing Overview](/1.5/contributing/) to understand the contribution workflow
