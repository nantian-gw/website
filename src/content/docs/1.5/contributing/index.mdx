...
description: "How to contribute to Nantian Gateway, including reporting bugs, writing code, improving documentation, and the pull request workflow."
slug: 1.5/contributing
---
...
| Channel | Purpose |
|---------|---------|
| [GitHub Issues](https://github.com/nantian-gw/gateway/issues) | Bug reports, feature requests, technical discussions, usage questions, design proposals |
...
| Repository | Language | GitHub | Description |
|-----------|----------|--------|-------------|
| `gateway` | Go | [nantian-gw/gateway](https://github.com/nantian-gw/gateway) | Control plane, translators, admin API |
| `dataplane` | Rust | [nantian-gw/dataplane](https://github.com/nantian-gw/dataplane) | HTTP/gRPC/TCP/UDP proxy, AI gateway, Wasm runtime |
| `helm-charts` | YAML/Go templates | [nantian-gw/helm-charts](https://github.com/nantian-gw/helm-charts) | Helm chart for deployment |
| `dashboard` | TypeScript/Next.js | [nantian-gw/dashboard](https://github.com/nantian-gw/dashboard) | Admin web UI |
| `website` | MDX/Astro | [nantian-gw/website](https://github.com/nantian-gw/website) | Documentation site |
| `proto` | Protobuf | [nantian-gw/proto](https://github.com/nantian-gw/proto) | Shared protobuf definitions |
| `platform-release` | Shell/Python | [nantian-gw/platform-release](https://github.com/nantian-gw/platform-release) | Release manifests, conformance, nightly benchmarks |
...
* See [Development Setup](/1.5/contributing/development) to learn how to set up your local development environment
* See [Testing Guide](/1.5/contributing/testing) to understand the test framework and workflow
* See [Release Process](/1.5/contributing/release) to learn about version release rules
