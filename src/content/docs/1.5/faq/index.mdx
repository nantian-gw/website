...
description: "Answers to common questions about Nantian Gateway architecture, deployment, AI gateway features, Wasm plugins, troubleshooting, and security."
slug: 1.5/faq
---
...
See the [Comparison](/1.5/overview/v1.5-comparison/) page for a detailed analysis.
...
See the [High Availability](/1.5/installation/ha) page for detailed configuration.
...
See the [Upgrade Guide](/1.5/installation/upgrade) for detailed instructions.
...
See the [Metrics Reference](/1.5/operations/metrics) and [Grafana Dashboard](/1.5/operations/grafana) pages for detailed configuration.
...
See the [Troubleshooting](/1.5/operations/troubleshooting) page for detailed steps.
...
See [Performance Tuning](/1.5/configuration/tuning) for all available knobs.
...
See [TLS / mTLS](/1.5/configuration/tls) for complete configuration.
...
See the [Contributing Overview](/1.5/contributing/) page. In short:
