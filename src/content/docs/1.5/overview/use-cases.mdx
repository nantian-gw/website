---
title: Use Cases
description: "Explore real-world deployment patterns for Nantian Gateway including AI gateway, Kubernetes ingress, multi-protocol proxy, and sidecar-free service mesh."
...
See the [Production Installation](/1.5/installation/production/) guide for a complete walkthrough.
...
- [Quick Start: deploy in 5 minutes](/1.5/getting-started/quick-start/)
- [AI Gateway feature guide](/1.5/features/ai-gateway/)
- [Wasm plugin feature guide](/1.5/features/wasm-plugins/)
- [Production deployment guide](/1.5/installation/production/)
