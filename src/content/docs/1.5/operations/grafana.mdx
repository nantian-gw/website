...
description: "Import and customize the pre-built Grafana dashboard for monitoring Nantian Gateway control plane and data plane health, performance, and resource utilization."
slug: 1.5/operations/grafana
---
...
:::note
Grafana alerts are evaluated by the Grafana server, not Prometheus. For production alerting, configure Prometheus alerting rules and use Alertmanager for notification routing. See [Alerting Rules](/1.5/operations/alerting) for recommended rules.
:::
...
* [Alerting Rules](/1.5/operations/alerting) -- configure alerts for the metrics you're now monitoring
* [Metrics Reference](/1.5/operations/metrics) -- complete catalog of all metrics used in the dashboard
* [Troubleshooting](/1.5/operations/troubleshooting) -- what to do when the dashboard shows problems
