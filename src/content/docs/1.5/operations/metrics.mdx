...
description: "Complete reference of all Prometheus metrics emitted by Nantian Gateway control plane and data plane, with scraping configuration examples."
slug: 1.5/operations/metrics
---
...
* [Grafana Dashboard](/1.5/operations/grafana) -- import and customize the pre-built dashboard
* [Alerting Rules](/1.5/operations/alerting) -- alerting rules you should configure
* [Configuration: Observability](/1.5/configuration/observability) -- logging, metrics, and tracing configuration
