...
* [Gateway API Concepts](/1.5/concepts/gateway-api) — understand the Kubernetes resources the control plane watches
* [Architecture Details](/1.5/architecture/) — deep dive into control plane and data plane internals
* [Quick Start](/1.5/getting-started/quick-start) — deploy the split-plane architecture in your cluster
