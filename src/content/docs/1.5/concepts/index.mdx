...
These pages explain the *what* and *why* before the *how*. For implementation details, see the [Getting Started](/1.5/getting-started/quick-start) and [Configuration](/1.5/configuration/) sections.
...
* [Understanding the Gateway API](/1.5/concepts/gateway-api) — learn the resource model
* [Split-Plane Architecture](/1.5/concepts/split-plane) — understand the control plane and data plane design
* [Quick Start](/1.5/getting-started/quick-start) — deploy Nantian Gateway in five minutes
