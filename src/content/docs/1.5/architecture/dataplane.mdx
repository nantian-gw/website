...
slug: 1.5/architecture/dataplane
---
...
* [Admin API](/1.5/architecture/admin-api) -- API for inspecting and managing the gateway
* [Metrics Reference](/1.5/operations/metrics) -- complete Prometheus metrics catalog
* [Configuration: Data Plane](/1.5/configuration/dataplane) -- all configuration parameters
