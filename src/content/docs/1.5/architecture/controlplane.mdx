...
slug: 1.5/architecture/controlplane
---
...
* [Data Plane Design](/1.5/architecture/dataplane) -- how the Rust proxy handles traffic
* [Admin API](/1.5/architecture/admin-api) -- API reference for the admin server
* [Configuration: Control Plane](/1.5/configuration/controlplane) -- all configuration parameters
