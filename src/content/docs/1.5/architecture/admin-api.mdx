---
title: Admin API
slug: 1.5/architecture/admin-api
---
...
:::caution
The Admin API provides full read access to your gateway configuration, including secrets, backend addresses, and route details. Never expose `adminAddr` to external networks without TLS and authentication. See [TLS / mTLS](/1.5/configuration/tls) for configuration details.
:::
...
* [API Reference: Admin API](/1.5/api-reference/admin-api) -- OpenAPI specification and client libraries
* [Operations: Metrics Reference](/1.5/operations/metrics) -- complete Prometheus metrics catalog
* [Configuration: Control Plane](/1.5/configuration/controlplane) -- admin server configuration
