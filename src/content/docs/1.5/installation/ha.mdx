...
description: "Configure high availability for Nantian Gateway with multi-replica deployments, zone-aware scheduling, leader election, and failure recovery strategies."
slug: 1.5/installation/ha
---
...
**Dashboard**: Two replicas by default. The dashboard is stateless, so losing one affects only capacity, not availability. The gateway continues routing traffic normally.
