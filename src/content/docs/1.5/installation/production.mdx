...
description: "Production hardening checklist for Nantian Gateway covering resource limits, TLS, security contexts, observability, and multi-zone deployment."
slug: 1.5/installation/production
---
...
**Downstream TLS** for traffic entering the gateway. This is configured through Gateway API listeners, not the Helm chart. See the [TLS configuration guide](/1.5/configuration/tls) for details.
