export const docsSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'AI Gateway', translations: { 'zh-CN': 'AI 网关' },
        items: [
          { label: 'Overview', link: 'features/ai-gateway' },
          { label: 'Model Routing', link: 'features/ai-gateway/model-routing' },
          { label: 'Semantic Cache', link: 'features/ai-gateway/semantic-cache' },
          { label: 'Prompt Guard', link: 'features/ai-gateway/prompt-guard' },
          { label: 'Content Safety', link: 'features/ai-gateway/content-safety' },
          { label: 'PII Masking', link: 'features/ai-gateway/pii-masking' },
          { label: 'A/B Testing', link: 'features/ai-gateway/ab-testing' },
          { label: 'Fallback Chains', link: 'features/ai-gateway/fallback' },
          { label: 'Cost Tracking', link: 'features/ai-gateway/cost-tracking' },
          { label: 'Multi-Tenant', link: 'features/ai-gateway/multitenant' },
          { label: 'Langfuse Observability', link: 'features/ai-gateway/langfuse' },
          { label: 'Token Policies', link: 'features/ai-gateway/token-policy' },
        ],
      },
  ...
  },
  {
    label: 'Guides',
    items: [
      { label: 'HTTPRoute and GRPCRoute', link: 'guides/grpc-routes' },
      { label: 'Stream and TCP Routes', link: 'guides/stream-routes' },
      { label: 'Load Balancing', link: 'guides/load-balancing' },
      { label: 'Circuit Breaker', link: 'guides/circuit-breaker' },
      { label: 'Retry Policies', link: 'guides/retry' },
      { label: 'Session Persistence', link: 'guides/session-persistence' },
      { label: 'Request Mirroring', link: 'guides/request-mirroring' },
      { label: 'WASM Plugin Development', link: 'guides/wasm-plugin-dev' },
    ],
  },
  {
